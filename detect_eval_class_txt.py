        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    txt = open(opt.eval_classtxt_path + '/%s' % names[int(cls)], 'a')   # 打开以类命名的txt，a表示后追，
                    # 文件不存在，则创建新文件写入
...
if __name__ == '__main__':
    ...
    dir = "/media/server/zjt00000/yolov5-master/data_test/imgs_name_manual.txt"
    ...
    predictions_manual = "/media/server/zjt00000/yolov5-master/data_test/predictions_manual/"
    # class_txt_manual='../data_test/class_txt_manual'
    class_txt_manual = "/media/server/zjt00000/yolov5-master/data_test/class_txt_manual/"
    # cachedir_manual='../data_test/cachedir_manual'
    cachedir_manual = "/media/server/zjt00000/yolov5-master/data_test/cachedir_manual/"
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='../runs/train/exp/weights/last.pt',
