...
# root_dir = r"D:\Desktop\Python\data\dataiccv\VisDrone2019-DET-train\VisDrone2019-DET-train"
...
if __name__ == '__main__':
    ...
    '''
    xml_dir = 'D:\Desktop\GT\label' + '\\'
    # xml_dir = os.path.join(root_dir, d)
    image_dir = 'D:\Desktop\GT\image' + '\\'
    label_dir = 'D:\Desktop\GT\labels_txt' + '\\'
    # label_dir = os.path.join(root_dir, c)
    data_split_dir = r'D:\Desktop\GT\train_namelist' + '\\'
    '''
