                ...
                if exiset_obj_list != []:  # 如果为空,说明切出来的这一张图不存在目标
                    ...
                    if zero_frac >= zero_frac_thresh:
                        ...
                        outpath = os.path.join(outdir, out_name + \
                                               '|' + str(y) + '_' + str(x) + '_' + str(sliceHeight) + '_' + str(
                            sliceWidth) + \
...
if __name__ == "__main__":
    ...
    raw_ann_dir = 'D:\Desktop\GT\oneimagelabel'
    slice_voc_dir = 'D:\Desktop\GT\label_xml'  # 切出来的标签也保存为voc格式
    outdir = 'D:\Desktop\GT\patch_xml'
